//~~tv:6026.20160105
//~~tc: Updates include:
//      Can now set a default a event
//      Product details pull from u.data when E-Comm extension isn't available
//      Fix logic for auto add of Purchase event
//      Add agent param of tlm


//tealium universal tag - utag.sender.6026 ut4.0.201611012136, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.loader_cb = function () {
          ...
          if (u.data.evt_list.toString().indexOf("Purchase") === -1 && g.order_id) {
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type": "script",  "src": u.data.base_url, "cb": u.callBack, "loc": "script", "id": 'utag_182'});
            //FB PreLoad Code
            !function (f, b, e) {
