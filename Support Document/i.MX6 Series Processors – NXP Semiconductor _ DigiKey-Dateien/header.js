...
(function () {
  ...
  function invokeChange(lang, cur) {
    ...
    if (window.dcsMultiTrack) {
      window.dcsMultiTrack('WT.z_ref_page_event', isLangToggle ? 'Change Language' : 'Change Currency', 'WT.z_lang', legacyLang, 'WT.site', site, 'WT.z_page_curr', __headerData.cur);
