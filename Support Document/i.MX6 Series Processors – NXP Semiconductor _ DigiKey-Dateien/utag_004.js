...
//tealium universal tag - utag.sender.googleadwords ut4.0.201604252102, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try{
(function(id,loader,u){
  ...
  u.map={"part_id":"google_custom_params.ecomm_prodid","supplier_id":"google_custom_params.ecomm_supplier","gr_page_type":"google_custom_params.ecomm_pagetype"};
...
function(a,b){ try{ if((b['page_content_group'].toString().toLowerCase().indexOf('Part Search'.toLowerCase())>-1&&b['page_content_sub_group'].toString().toLowerCase().indexOf('Part Detail'.toLowerCase())>-1)){b['gr_page_type']='product_detail'} } catch(e){ utag.DB(e) }  },
